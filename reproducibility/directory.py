...
# Load the JSON data
with open("/home/ege/rawcovar/reproducibility/settings.json", 'r') as file:
...
RAW_WAVEFORMS_HDF5_PATH=settings["DATASET_DIRECTORIES"]["RAW_WAVEFORMS_HDF5_PATH"]
RAW_WAVEFORMS_MSEED_PATH=settings["DATASET_DIRECTORIES"]["RAW_WAVEFORMS_MSEED_PATH"]
RAW_WAVEFORMS_METADATA_CSV_DIR=settings["DATASET_DIRECTORIES"]["RAW_WAVEFORMS_METADATA_CSV_DIR"]
